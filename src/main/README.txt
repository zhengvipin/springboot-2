...
4.安装 nodejs
5.open cmd:
直接运行: npm --registry=https://registry.npm.taobao.org i -g live-server
6.open cmd 进入目录:
d:
cd D:\..\IdeaProjects\ssm\ssm\src\main\webfrontend
7.启动前端服务器
live-server --no-browser 启动后不自动打开浏览器
live-server              启动后自动打开浏览器
8.chrome: 127.0.0.1:8080
# **************************************************************************